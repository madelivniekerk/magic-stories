...
h1{font-family:'Nunito',sans-serif !important; font-size:clamp(26px,3.8vw,40px) !important; font-weight:600 !important; color:#a888c8 !important; margin:8px 0 0 !important;}
h2{font-family:'Nunito',sans-serif !important; font-size:clamp(24px,3.2vw,36px) !important; font-weight:600 !important; color:#a888c8 !important; margin:8px 0 6px !important;}
...
WHO_OPTIONS = [
    {"em":"🦄","lbl":"Brave unicorn","val":"Luna the brave unicorn","minAge":5},
    {"em":"🦊","lbl":"Curious fox","val":"Pip the curious fox","minAge":5},
    {"em":"🐉","lbl":"Shy dragon","val":"Ember the shy dragon","minAge":5},
    {"em":"🧒","lbl":"A hero like me","val":"a brave young explorer just like you","minAge":5},
    {"em":"🐰","lbl":"Clever rabbit","val":"Sage the clever rabbit","minAge":5},
    {"em":"🦁","lbl":"Gentle lion","val":"Rumi the gentle lion","minAge":5},
    {"em":"🐙","lbl":"Octopus inventor","val":"Otto the octopus inventor","minAge":5},
    {"em":"🦋","lbl":"Brave butterfly","val":"Mira the brave butterfly","minAge":5},
    {"em":"🤖","lbl":"Friendly robot","val":"Bolt the friendly robot","minAge":5},
    {"em":"🐻","lbl":"Cuddly bear","val":"Bruno the brave bear","minAge":5},
    {"em":"🧚","lbl":"Tiny fairy","val":"Faye the tiny fairy","minAge":5},
    {"em":"🦕","lbl":"Baby dinosaur","val":"Dot the baby dinosaur","minAge":5},
    {"em":"🐢","lbl":"Wise turtle","val":"Tomo the wise turtle","minAge":5},
    {"em":"🦉","lbl":"Night owl","val":"Olwen the night owl","minAge":5},
    {"em":"🐼","lbl":"Panda warrior","val":"Bao the brave panda","minAge":5},
    {"em":"🦔","lbl":"Tiny hedgehog","val":"Quill the tiny hedgehog","minAge":5},
    {"em":"🐧","lbl":"Bold penguin","val":"Pim the bold penguin","minAge":5},
    {"em":"🦝","lbl":"Sneaky raccoon","val":"Roxy the clever raccoon","minAge":5},
    {"em":"🐝","lbl":"Busy bee","val":"Buzz the busy bee","minAge":5},
    {"em":"🧜","lbl":"Brave merchild","val":"Marina the brave merchild","minAge":5},
    {"em":"🧑‍🔬","lbl":"Young inventor","val":"Zara the brilliant young inventor","minAge":9},
    {"em":"⚔️","lbl":"Reluctant warrior","val":"Cael the reluctant young warrior","minAge":9},
    {"em":"🔍","lbl":"Sharp detective","val":"Mira the sharp-eyed young detective","minAge":9},
    {"em":"🌀","lbl":"Shape-shifter","val":"Dax the shape-shifting outcast","minAge":9},
    {"em":"🃏","lbl":"Street trickster","val":"Lace the street-smart trickster","minAge":9},
    {"em":"🏹","lbl":"Exiled archer","val":"Fen the exiled young archer","minAge":9},
    {"em":"👤","lbl":"Disgraced noble","val":"Ren the disgraced young noble","minAge":11},
    {"em":"🕰️","lbl":"Time-lost wanderer","val":"Lira the time-lost wanderer","minAge":11},
    {"em":"🌗","lbl":"Cursed heir","val":"Sable the cursed heir to a forgotten throne","minAge":11},
    {"em":"🧠","lbl":"Reluctant prophet","val":"Ora the reluctant prophet who sees too much","minAge":11},
]
VILLAIN_OPTIONS = [
    {"em":"🐲","lbl":"Dark dragon","val":"Scorch the dark dragon","minAge":5},
    {"em":"🧙","lbl":"Evil wizard","val":"Maldrix the evil wizard","minAge":5},
    {"em":"👹","lbl":"Grumpy ogre","val":"Grunk the grumpy ogre","minAge":5},
    {"em":"🦁","lbl":"Jealous lion","val":"Rex the jealous lion king","minAge":5},
    {"em":"🕷️","lbl":"Shadow spider","val":"Vex the shadow spider","minAge":5},
    {"em":"🐍","lbl":"Cunning snake","val":"Sly the cunning snake","minAge":5},
    {"em":"👿","lbl":"Trickster imp","val":"Nim the trickster imp","minAge":5},
    {"em":"🌪️","lbl":"Storm witch","val":"Gale the storm witch","minAge":5},
    {"em":"🦂","lbl":"Desert scorpion","val":"Sting the desert scorpion","minAge":5},
    {"em":"🐺","lbl":"Lone wolf","val":"Shadow the lone wolf","minAge":5},
    {"em":"🧟","lbl":"Grumpy zombie","val":"Rott the grumpy zombie","minAge":5},
    {"em":"👻","lbl":"Mischief ghost","val":"Wisp the mischievous ghost","minAge":5},
    {"em":"🐊","lbl":"River croc","val":"Snap the river crocodile","minAge":5},
    {"em":"🦈","lbl":"Storm shark","val":"Razor the storm shark","minAge":5},
    {"em":"🧛","lbl":"Night count","val":"Vane the count of the night","minAge":5},
    {"em":"🤖","lbl":"Broken robot","val":"Rust the broken rogue robot","minAge":5},
    {"em":"🌑","lbl":"Shadow king","val":"Umbra the shadow king","minAge":5},
    {"em":"🪄","lbl":"Sneaky sorcerer","val":"Trick the sneaky sorcerer","minAge":5},
    {"em":"🐻","lbl":"Cave bear","val":"Grizzle the cave bear","minAge":5},
    {"em":"🦉","lbl":"Jealous owl","val":"Dusk the jealous owl sage","minAge":5},
    {"em":"🎭","lbl":"Fallen mentor","val":"Theron the fallen mentor, once a hero himself","minAge":9},
    {"em":"💀","lbl":"Cursed king","val":"Valdris the ancient cursed king","minAge":9},
    {"em":"🌿","lbl":"Nature's wrath","val":"The Verdant, a spirit of nature turned vengeful","minAge":9},
    {"em":"🕴️","lbl":"Silver deceiver","val":"Seraph the silver-tongued deceiver","minAge":9},
    {"em":"🌑","lbl":"Corrupted guardian","val":"The Warden, once protector, now betrayer","minAge":11},
    {"em":"🪞","lbl":"The shadow self","val":"the hero's own shadow, grown dark and powerful","minAge":11},
    {"em":"🧩","lbl":"The Architect","val":"the Architect, who controls fate from the shadows","minAge":11},
    {"em":"⚖️","lbl":"Twisted idealist","val":"Commander Voss, who believes cruelty is justice","minAge":11},
]
FRIEND_OPTIONS = [
    {"em":"🐶","lbl":"Loyal dog","val":"Rex the loyal dog","minAge":5},
    {"em":"🐱","lbl":"Magic cat","val":"Whisper the magic cat","minAge":5},
    {"em":"🦅","lbl":"Eagle scout","val":"Talon the eagle scout","minAge":5},
    {"em":"🐢","lbl":"Wise turtle","val":"Shell the wise old turtle","minAge":5},
    {"em":"🦋","lbl":"Fairy guide","val":"Glow the fairy guide","minAge":5},
    {"em":"🐧","lbl":"Brave penguin","val":"Flip the brave penguin","minAge":5},
    {"em":"🦜","lbl":"Talking parrot","val":"Pip the talking parrot","minAge":5},
    {"em":"🐴","lbl":"Winged horse","val":"Skye the winged horse","minAge":5},
    {"em":"🐸","lbl":"Lucky frog","val":"Leap the lucky frog","minAge":5},
    {"em":"🐘","lbl":"Strong elephant","val":"Rumble the gentle elephant","minAge":5},
    {"em":"🐬","lbl":"Dolphin friend","val":"Splash the dolphin","minAge":5},
    {"em":"🦌","lbl":"Swift deer","val":"Arrow the swift deer","minAge":5},
    {"em":"🐇","lbl":"Lucky rabbit","val":"Clover the lucky rabbit","minAge":5},
    {"em":"🌟","lbl":"Star sprite","val":"Lumi the star sprite","minAge":5},
    {"em":"🧝","lbl":"Wood elf","val":"Leaf the wood elf","minAge":5},
    {"em":"🐻‍❄️","lbl":"Snow bear","val":"Frost the snow bear","minAge":5},
    {"em":"🐝","lbl":"Bee companion","val":"Zara the bee companion","minAge":5},
    {"em":"🧞","lbl":"Friendly genie","val":"Jinn the friendly genie","minAge":5},
    {"em":"🤖","lbl":"Robot pal","val":"Cog the helpful robot pal","minAge":5},
    {"em":"🦊","lbl":"Clever helper","val":"Finn the clever helper fox","minAge":5},
    {"em":"🧑‍🏫","lbl":"Eccentric scholar","val":"Professor Wren the eccentric scholar","minAge":9},
    {"em":"⚔️","lbl":"Rival turned ally","val":"Kira the rival turned reluctant ally","minAge":9},
    {"em":"🌊","lbl":"Elemental spirit","val":"Tide, the ancient and unpredictable water spirit","minAge":9},
    {"em":"🎲","lbl":"Roguish rascal","val":"Crick the charming rogue with a hidden heart","minAge":9},
    {"em":"👁️","lbl":"Mysterious stranger","val":"the Nameless, a mysterious wanderer with no past","minAge":11},
    {"em":"🌗","lbl":"Former enemy","val":"Vael, a former enemy who now fights by the hero's side","minAge":11},
    {"em":"📜","lbl":"Ancient oracle","val":"the Oracle, ancient beyond measure and cryptic in speech","minAge":11},
    {"em":"🤐","lbl":"Silent guardian","val":"the Silent, a wordless protector whose loyalty never wavers","minAge":11},
]
WHERE_OPTIONS = [
...
STEPS = [
    ...
    {"id":"who","idx":2,"accent":"gold","required":True,
     ...
     "write_prompt":"✏️ Tell us all about your hero! What is their name? How old are they? What do they look like — hair, eyes, clothes? And what is their personality like — are they brave, shy, funny, hot-headed, kind?",
     "starters":["My hero's name is…","They are … years old and they look…","Their personality is…","One thing that makes them different is…"]},
    {"id":"villain","idx":3,"accent":"pink","required":False,
     ...
     "write_prompt":"✏️ Tell us about your villain! What is their name? How old are they? What do they look like? What is their personality — cold, cunning, furious, sneaky? And what do they want, and what will they do to get it?",
     "starters":["My villain's name is…","They look…and their personality is…","What they want most is…","To get it, they will…"]},
    {"id":"friend","idx":4,"accent":"green","required":False,
     ...
     "write_prompt":"✏️ Tell us about your sidekick! What is their name? How old are they? What do they look like? What is their personality — loyal, cheeky, wise, clumsy? What do they want, and what special thing do they do to help?",
     "starters":["My sidekick's name is…","They look…and their personality is…","What they want most is…","Their special ability is…"]},
...
# ── Cast & World reminder strip ───────────────────────────────────────────────
def render_cast_reminder():
    CAST_FIELDS = [
        ("wiz_who",     "Hero",    "#d4af37"),
        ("wiz_villain", "Villain", "#c084fc"),
        ("wiz_friend",  "Sidekick","#86efac"),
        ("wiz_where",   "Where",   "#93c5fd"),
        ("wiz_when",    "When",    "#fda4af"),
    ]
    chips_html = ""
    for key, label, colour in CAST_FIELDS:
        val = (st.session_state.get(key) or {}).get("val", "")
        if val:
            chips_html += (
                f'<div style="display:inline-block;margin:3px 4px;padding:5px 10px;'
                f'border-radius:20px;background:rgba(20,5,45,.75);'
                f'border:1px solid {colour}44;">'
                f'<span style="font-family:Cinzel,serif;font-size:.55rem;color:{colour};'
                f'letter-spacing:.1em;text-transform:uppercase;">{label}&nbsp;</span>'
                f'<span style="font-family:Spectral,serif;font-size:.78rem;color:#d4c5e8;">{val}</span>'
                f'</div>'
            )
    ...
    if word_names:
        chips_html += (
            f'<div style="display:inline-block;margin:3px 4px;padding:5px 10px;'
            f'border-radius:20px;background:rgba(20,5,45,.75);border:1px solid #f9a8d444;">'
            f'<span style="font-family:Cinzel,serif;font-size:.55rem;color:#f9a8d4;'
            f'letter-spacing:.1em;text-transform:uppercase;">Magic words&nbsp;</span>'
            f'<span style="font-family:Spectral,serif;font-size:.78rem;color:#d4c5e8;">{", ".join(word_names)}</span>'
            f'</div>'
        )
    if chips_html:
        st.markdown(
            f'<div style="margin-bottom:14px;padding:8px 4px;border-bottom:1px solid rgba(212,175,55,.12);">'
            f'<span style="font-family:Cinzel,serif;font-size:.55rem;color:#9a7ab0;'
            f'letter-spacing:.15em;text-transform:uppercase;margin-right:6px;">Your story so far ✦</span>'
            f'{chips_html}</div>',
            unsafe_allow_html=True,
        )
